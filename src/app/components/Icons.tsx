...
export const TwitterIcon = ({ size = 24, className = "" }: { size?: number; className?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M22 4s-1 2.1-3 2.3c1.1.7 2 1.8 2 3.1 0 0-2-1.3-3.2-1.3-1.1 0-2 .9-2 2s.9 2 2 2c0 0-4 1-6-1 0 0 1 4 5 4 0 0-2 1-4 1 0 0 5 3 11-1 0 0 1-5 1-9 0 0 1-1 1-2z"></path>
  </svg>
);
